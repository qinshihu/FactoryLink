...
- **Excel 가져오기**: Excel에서 포인트 설정 일괄 가져오기
...
| **디바이스 설정** | 디바이스 추가/편집/삭제, 프로토콜별 설정 항목, 포인트 테이블 CRUD, Excel 가져오기/템플릿 다운로드, 연결 테스트 |
| **시스템 설정** | MQTT 설정, 수집 간격, 재연결 전략, 부팅 시 자동 시작, 로그 보기 (레벨 필터링 지원) |
